...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
  modifier onlyOwner () {
    require(msg.sender == owner,"Only Owner can Open");
    _;
  }
  ...
  /* Add a keyword so the function can be paid.
   ...
   -: Always payable must always return a boolean.
   -: The arrangement is always functionName Modifiers Function Type e.g Payable function visibility e.g public and return type.
*/


  function buyItem(uint sku) forSale(sku) checkValue(sku) paidEnough(msg.value) payable public returns (bool) {
